...
export const SectionNav: React.FC<SectionNavProps> = ({ activePart }) => {
    ...
    switch (activePart) {
      ...
      case 'part2':
        return [
          ...
          { id: 'p2-[#p2-sla]', label: '2.3 SLA & Риски', href: '#p2-sla' },
      ...
      case 'part3':
        return [
          ...
          { id: 'p3-[#p3-mindset]', label: '3.3 AI-Native Workflow', href: '#p3-mindset' },
          { id: 'p3-evidence', label: '3.4 Доказательный слой', href: '#p3-evidence' },
        ];
      default:
        return [
          { id: 'overview', label: 'Обзор проекта', href: '#hero' },
          { id: 'part1-link', label: 'Часть 1: Инструмент', href: '#part-1' },
          { id: 'part2-link', label: 'Часть 2: Автоматизация', href: '#part-2' },
          { id: 'part3-link', label: 'Часть 3: Автор', href: '#part-3' },
        ];
    }
  };
  ...
  return (
    <div className="bg-[#FAF7F2] border-b border-[#E8E0D7] py-2 px-4 sticky top-20 z-40 backdrop-blur-sm">
